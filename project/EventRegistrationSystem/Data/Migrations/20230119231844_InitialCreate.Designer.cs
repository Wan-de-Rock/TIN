...
namespace EventRegistrationSystem.Data.Migrations
{
    ...
    [Migration("20230119231844_InitialCreate")]
            ...
            modelBuilder.Entity("EventRegistrationSystem.Models.Performance", b =>
                {
                    b.HasOne("EventRegistrationSystem.Models.Artist", "Artist")
                        .WithOne("Performance")
                        .HasForeignKey("EventRegistrationSystem.Models.Performance", "ArtistId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("EventRegistrationSystem.Models.Event", "Event")
                        .WithOne("Performance")
                        .HasForeignKey("EventRegistrationSystem.Models.Performance", "EventId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
